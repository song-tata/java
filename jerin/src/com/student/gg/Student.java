...
public class Student implements User {
	...
	public void setFeedback() {
		...
		Scanner scanner = new Scanner(System.in); // scanner 객체를 while 루프 밖에서 생성
		try (FileWriter fw = new FileWriter("StudentFeedback.txt", true)) {
			while (flag) {
				...
				scanner.nextLine(); // scanner 객체를 사용하여 사용자 입력 대기
				System.out.println("더 바라는 점이 있으신가요?Y/N");
				String yesOrNo = scanner.next(); // scanner 객체를 사용하여 사용자 입력 받기
